...
import com.tccversaofinal.Adaptadores.AdaptadorFragmentF;
...
public class FragmentF extends android.support.v4.app.Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        firebase = ConfiguracaoFirebase.getFirebase().child("projetos").child(identificadorProjeto).child("fragmentF");
        ...
        adapter = new AdaptadorFragmentF(getActivity(), tarefas );
