...
import com.tccversaofinal.Adaptadores.AdaptadorFragmentD;
...
public class FragmentD extends android.support.v4.app.Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        firebase = ConfiguracaoFirebase.getFirebase().child("projetos").child(identificadorProjeto).child("fragmentD");
        ...
        adapter = new AdaptadorFragmentD(getActivity(), tarefas );
