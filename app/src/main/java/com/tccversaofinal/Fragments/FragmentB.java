...
import com.tccversaofinal.Adaptadores.AdaptadorFragmentB;
...
public class FragmentB extends android.support.v4.app.Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        firebase = ConfiguracaoFirebase.getFirebase().child("projetos").child(identificadorProjeto).child("fragmentB");
        ...
        adapter = new AdaptadorFragmentB(getActivity(), tarefas );
