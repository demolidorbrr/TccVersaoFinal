...
import com.tccversaofinal.Adaptadores.AdaptadorFragmentE;
...
public class FragmentE extends android.support.v4.app.Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        firebase = ConfiguracaoFirebase.getFirebase().child("projetos").child(identificadorProjeto).child("fragmentE");
        ...
        adapter = new AdaptadorFragmentE(getActivity(), tarefas );
