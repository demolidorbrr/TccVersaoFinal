...
public class AdaptadorFragmentF extends ArrayAdapter<Tarefas> {
    ...
    public AdaptadorFragmentF(Context c, ArrayList<Tarefas> objects) {
        super(c, 0, objects);
        this.context = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                preferencias.salvarTarefa(t.getNome(), t.getDescricao(), "fragmentF", t.getId());
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            switch (categoriaAMover[0]) {
                                                case 0:
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentF").child(tarefa.getId()).child("comentarios").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            // Limpar mensagens
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentF").child(tarefa.getId()).child("historico").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            // Limpar mensagens
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentF").child(tarefa.getId()).child("responsaveis").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            // Limpar mensagens
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentF").child(tarefa.getId()).child("anexos").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            // Limpar mensagens
                                                            todosAnexos.clear();
                                                    ...
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[5] + " para a lista " + vet2[0] + " em " + historico.getData() + " as " + historico.getHora());
                                                ...
                                                case 1:
                                                    ...
                                                    historico.setHora(hora_atual);
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[5] + " para a lista " + vet2[1] + " em " + historico.getData() + " as " + historico.getHora());
                                                    firebase.child("projetos").child(identificadorProjeto).child("historico").child(historico.getId()).setValue(historico);
                                                ...
                                                case 2:
                                                    ...
                                                    historico.setHora(hora_atual);
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[5] + " para a lista " + vet2[2] + " em " + historico.getData() + " as " + historico.getHora());
                                                    firebase.child("projetos").child(identificadorProjeto).child("historico").child(historico.getId()).setValue(historico);
                                                ...
                                                case 3:
                                                    ...
                                                    historico.setHora(hora_atual);
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[5] + " para a lista " + vet2[3] + " em " + historico.getData() + " as " + historico.getHora());
                                                    firebase.child("projetos").child(identificadorProjeto).child("historico").child(historico.getId()).setValue(historico);
                                                ...
                                                case 4:
                                                    ...
                                                    historico.setHora(hora_atual);
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[5] + " para a lista " + vet2[4] + " em " + historico.getData() + " as " + historico.getHora());
                                                    firebase.child("projetos").child(identificadorProjeto).child("historico").child(historico.getId()).setValue(historico);
