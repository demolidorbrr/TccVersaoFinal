    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                preferencias.salvarTarefa(t.getNome(), t.getDescricao(), "fragmentA", t.getId());
                ...
                builder.setTitle(view.getResources().getString(R.string.choose_action)).setItems(R.array.actions_array, new DialogInterface.OnClickListener() {
                    public void onClick(final DialogInterface dialog, int which) {
                        if(which == 0) {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            switch (categoriaAMover[0]) {
                                                ...
                                                case 1:
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentA").child(tarefa.getId()).child("comentarios").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            // Limpar mensagens
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentA").child(tarefa.getId()).child("historico").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            // Limpar mensagens
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentA").child(tarefa.getId()).child("responsaveis").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            // Limpar mensagens
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentA").child(tarefa.getId()).child("anexos").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        @Override
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            // Limpar mensagens
                                                            todosAnexos.clear();
                                                    ...
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[0] + " para a lista " + vet2[1] + " em " + historico.getData() + " as " + historico.getHora());
                                                ...
                                                case 2:
                                                    ...
                                                    historico.setHora(hora_atual);
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[0] + " para a lista " + vet2[2] + " em " + historico.getData() + " as " + historico.getHora());
                                                ...
                                                case 3:
                                                    ...
                                                    historico.setHora(hora_atual);
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[0] + " para a lista " + vet2[3] + " em " + historico.getData() + " as " + historico.getHora());
                                                ...
                                                case 4:
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentA").child(tarefa.getId()).child("comentarios").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            ...
                                                            for ( DataSnapshot dados: dataSnapshot.getChildren() ){
                                                                CartaoComentario c1 = dados.getValue( CartaoComentario.class );
                                                                todosComentarios.add(c1);
                                                                firebase.child("projetos").child(identificadorProjeto).child("fragmentE").child(tarefa.getId()).child("comentarios").child(c1.getId()).setValue(c1);
                                                            }
                                                        }
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentA").child(tarefa.getId()).child("historico").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            ...
                                                            for ( DataSnapshot dados: dataSnapshot.getChildren() ){
                                                                Historico h1 = dados.getValue( Historico.class );
                                                                todosHistorico.add(h1);
                                                                firebase.child("projetos").child(identificadorProjeto).child("fragmentE").child(tarefa.getId()).child("historico").child(h1.getId()).setValue(h1);
                                                            }
                                                        }
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentA").child(tarefa.getId()).child("responsaveis").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            ...
                                                            for ( DataSnapshot dados: dataSnapshot.getChildren() ){
                                                                Contato contato = dados.getValue( Contato.class );
                                                                todosResponsaveis.add(contato);
                                                                firebase.child("projetos").child(identificadorProjeto).child("fragmentE").child(tarefa.getId()).child("responsaveis").child(contato.getIdentificadorUsuario()).setValue(contato);
                                                            }
                                                        }
                                                    ...
                                                    firebase.child("projetos").child(identificadorProjeto).child("fragmentA").child(tarefa.getId()).child("anexos").addListenerForSingleValueEvent(new ValueEventListener() {
                                                        ...
                                                        public void onDataChange(DataSnapshot dataSnapshot) {
                                                            ...
                                                            for ( DataSnapshot dados: dataSnapshot.getChildren() ){
                                                                Anexo a = dados.getValue( Anexo.class );
                                                                todosAnexos.add(a);
                                                                firebase.child("projetos").child(identificadorProjeto).child("fragmentE").child(tarefa.getId()).child("anexos").child(a.getId()).setValue(a);
                                                            }
                                                        }
                                                    ...
                                                    historico.setHora(hora_atual);
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[0] + " para a lista " + vet2[4] + " em " + historico.getData() + " as " + historico.getHora());
                                                ...
                                                case 5:
                                                    ...
                                                    historico.setHora(hora_atual);
                                                    historico.setDescricao(nomeUsuario + " moveu a tarefa " + tarefa.getNome() + " da lista "+ vet2[0] + " para a lista " + vet2[5] + " em " + historico.getData() + " as " + historico.getHora());
                            ...
                            t2.setId(tarefa.getId());
                            firebase = ConfiguracaoFirebase.getFirebase();
                            firebase.child("projetos").child(identificadorProjeto).child("arquivo").child(tarefa.getId()).setValue(tarefa);
                            ...
                            historico.setHora(hora_atual);
                            historico.setDescricao(nomeUsuario + " arquivou a tarefa " + t2.getNome() + " em " + historico.getData() + " as " + historico.getHora());
                            firebase.child("projetos").child(identificadorProjeto).child("historico").child(historico.getId()).setValue(historico);

                            Toast.makeText(getContext(), "Movido para Arquivo com sucesso", Toast.LENGTH_LONG).show();
                        }
                            ...
                            firebase.child("projetos").child(identificadorProjeto).child("historico").child(historico.getId()).setValue(historico);
                            Toast.makeText(getContext(), "Cartão Deletado com sucesso", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                        .show();
